...
void main() {
  group('Food model', () {
    ...
    //   final Food result = Food(title: "60 min", time: 31, id: 1, imgLocalSource: "");
    //   expect(result.getTimeValue(), equals("31 минута"));
    // }, skip: false);
    // test('Time = 60 min (60 min)', () {
    //   final Food result = Food(title: "60 min", time: 60, id: 1, imgLocalSource: "");
    //   expect(result.getTimeValue(), equals("1 час"));
    // }, skip: false);
    // test('Time > 60 min (120 min)', () {
    //   final Food result = Food(title: "120 min", time: 120, id: 1, imgLocalSource: "");
    //   expect(result.getTimeValue(), equals("2 часа"));
    // }, skip: false);
